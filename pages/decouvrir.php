...
<div class="container mt-4">
    <div class="card landing-card mb-3">
        <div class="card-body">
            <h2 class="mb-2">Découvrir MadaDream en détail</h2>
            <p class="text-muted mb-0">
                Nous proposons une approche complète du séjour : hébergement, expériences locales,
                accompagnement sur place et suivi administratif clair.
            </p>
        </div>
    </div>
<!-- section pour les activités et les prestations -->
    ...
    <div class="landing-bottom-cta text-center mt-4">
